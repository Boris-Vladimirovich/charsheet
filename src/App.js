...
function App() {
  ...
  const handleSave = async () => {
    const arrayBuffer = await fetch(template).then(res => res.arrayBuffer());
    ...
    saveByteArray('Charsheet', pdfBytes);
  }
      ...
      <form className="charsheet">
        <header>
          <section className="charname">
            <label htmlFor="charname">Character Name</label><input name="charname" placeholder="Thoradin Fireforge" onChange={handleInputChange} />
          </section>
